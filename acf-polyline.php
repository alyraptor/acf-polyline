...
if( !class_exists('raptor_acf_plugin_polyline') ) :

class raptor_acf_plugin_polyline {
	...
	*/
	...
	function include_field( $version = false ) {
		...
		// load acf-polyline
		load_plugin_textdomain( 'acf-polyline', false, plugin_basename( dirname( __FILE__ ) ) . '/lang' ); 
		
		
		// include
		include_once('fields/class-raptor-acf-field-polyline-v' . $version . '.php');
	}
...
// initialize
new raptor_acf_plugin_polyline();
